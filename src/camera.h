...
void Camera_create_camera_rays(sCamera *cam, const uint32_t width_resolution, const uint32_t max_ray_count, Intersection::sRay *ray_list, glm::uvec2 *screen_ray_coords, uint32_t *ray_count);
